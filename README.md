...
**DNS Switcher Pro** با هدف رفع این مشکلات ساخته شده است.
...
اگر بخواهی این متن را به صورت README یا برای سایت GitHub آماده کنم، بگو تا فرمت markdown براش تولید کنم.
